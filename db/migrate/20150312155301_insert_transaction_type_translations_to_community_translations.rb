class InsertTransactionTypeTranslationsToCommunityTranslations < ActiveRecord::Migration
  def up
    ...
    add_index :community_translations, [:community_id, :translation_key, :locale], :name => "community_translations_key_locale" unless index_exists?(:community_translations, [:community_id, :translation_key, :locale])
    # Index for admin search for translations
    add_index :community_translations, [:community_id, :translation_key], :name => "community_translations_key"          unless index_exists?(:community_translations, [:community_id, :translation_key])
